...
<body>
    ...
    /* 
        ...
        */
    $kid = array ("Mike", "Dustin", "Will", "Lucas", "Max", "Eleven");// Lengkapi di sini
    print_r ($kid);
    echo "<br>";
    ...
    echo "<br>";
    echo "Total Kids : " . count($kid); // Berapa panjang array kids
    echo "<br>";
    echo "<ol>";
    echo "<li>" . $kid[0] . "</li>";
    echo "<li>" . $kid[1] . "</li>";
    ...
    /*
        ...
        */
                $bioPeople = [
                    ...
                    ["Name" => "Mike Wheeler", "Age" => "12", "Aliases" => "Dungion Master", "Status" => "Alive"],
